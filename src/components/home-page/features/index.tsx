...
const features = [
  ...
  {
    title: "Calendar Invite and Booking (coming soon) ",
    description:
  ...
  {
    title: "EmailList/Newsletter (coming soon)",
    description:
  ...
  {
    title: "1:1 Creator Strategy Coaching (coming soon) ",
    description:
  ...
  return (
    <div className="mt-16 md:mt-0">
      ...
      <p className="text-lg mt-4 text-slate-600 text-center">
        Lnkr is the easiest way to make money online. All of your courses,
        digital products, and bookings are now hosted within your link-in-bio.
      </p>
